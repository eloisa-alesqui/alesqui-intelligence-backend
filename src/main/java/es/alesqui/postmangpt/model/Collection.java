 ...
 */
@Document(collection = "postman_collections")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
...
public class Collection {
	...
	/**
	 * MongoDB document identifier - Internal database ID for this collection
	 * document. This is different from the Postman collection ID which is stored in
	 * info.postmanId. This field is automatically generated by MongoDB when the
	 * document is saved.
	 */
	@Id
	private String id;
