...
import es.alesqui.intelligence.model.postman.Body;
import es.alesqui.intelligence.model.postman.Description;
import es.alesqui.intelligence.model.postman.FormParameter;
import es.alesqui.intelligence.model.postman.Header;
import es.alesqui.intelligence.model.postman.QueryParam;
import es.alesqui.intelligence.model.postman.Request;
import es.alesqui.intelligence.model.postman.Url;
import es.alesqui.intelligence.model.postman.Variable;
import es.alesqui.intelligence.model.unified.UnifiedMediaType;
import es.alesqui.intelligence.model.unified.UnifiedParameter;
import es.alesqui.intelligence.model.unified.UnifiedRequestBody;
import es.alesqui.intelligence.model.unified.UnifiedResponse;
import es.alesqui.intelligence.model.unified.UnifiedSchema;
