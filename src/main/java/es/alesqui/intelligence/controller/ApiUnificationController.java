...
public class ApiUnificationController {
    ...
    public record UpdateApiStatusRequest(@NotNull(message = "active field is required") Boolean active) {}
    ...
    public Mono<ResponseEntity<UnifiedApiDocument>> updateApiConfiguration(
            ...
            @Valid @RequestBody ApiConfiguration apiConfiguration,
            ServerHttpRequest request) {
    ...
    public Mono<ResponseEntity<UnifiedApiDocument>> updateApiStatus(
            ...
            @Valid @RequestBody UpdateApiStatusRequest statusUpdate,
            ServerHttpRequest request) {
        ...
        return userService.getCurrentUsername()
                .flatMap(username -> apiGroupLinkService.canModifyApi(username, id)
                        .flatMap(canModify -> {
                            ...
                            return unifiedApiService.updateApiStatus(id, statusUpdate.active(), request)
                                    .map(ResponseEntity::ok)
