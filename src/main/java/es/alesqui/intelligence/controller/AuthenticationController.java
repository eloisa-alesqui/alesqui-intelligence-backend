...
public class AuthenticationController {
    ...
    public Mono<ActivateAccountResponse> activateAccount(@Valid @RequestBody ActivateAccountRequest request,
        ...
        return userManagementService.activateAccount(request.getToken(), request.getPassword(), httpRequest)
            ...
            .onErrorResume(e -> {
                ...
                return userManagementService.logUserOperationFailure(
    ...
    public Mono<ForgotPasswordResponse> forgotPassword(@Valid @RequestBody ForgotPasswordRequest request,
        ...
        return userManagementService.requestPasswordReset(request.getEmail(), httpRequest)
    ...
    public Mono<ResetPasswordResponse> resetPassword(@Valid @RequestBody ResetPasswordRequest request,
        ...
        return userManagementService.resetPassword(request.getToken(), request.getNewPassword(), httpRequest)
