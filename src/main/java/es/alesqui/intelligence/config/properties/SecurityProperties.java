...
public class SecurityProperties {
	...
	public static class Jwt {
		...
		private String secret = "alesquiintelligence-super-secret-key-change-in-production-minimum-256-bits-required";
		 ...
		 * JWT Token issuer
		 */
		private String issuer = "alesquiintelligence";

		/**
		 * JWT Token audience
		 */
		private String audience = "alesquiintelligence-users";
	...
	public static class Cors {
		...
		private List<String> allowedOrigins = List.of("http://localhost:3000", "http://localhost:8080",
				"https://intelligence.alesqui.com");
	...
	public static class OAuth2 {
		...
		private List<String> redirectUris = List.of("http://localhost:3000/auth/callback",
				"https://intelligence.alesqui.com/auth/callback");
