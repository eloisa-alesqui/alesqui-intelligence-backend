...
public class ApiInvocationTools {
    ...
    public ApiCallResponse callApi(
        ...
        emitStatus(toolContext, "Preparing API call to operation: " + operationId + "...");
        ...
        try {
            ...
            if (!inspectionPolicy.wasInspectedRecently(conversationId, api.getName(), opKey, Duration.ofMinutes(10))) {
                emitStatus(toolContext, "Inspection required before calling this endpoint.");
            ...
            emitStatus(toolContext, "Executing API call...");
            ...
            emitStatus(toolContext, "API call to '" + operationId + "' was successful.");
            return response;

        } catch (Exception e) {
            log.error("Error in callApi tool - API: '{}', Operation: '{}'", apiName, operationId, e);
            emitStatus(toolContext, "API call to '" + operationId + "' failed.");
